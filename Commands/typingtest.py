...
from Helper.__functions import m_line, command_user, command_response_timestamp, is_dm
...
class Typingtest(cmd.Cog):
	...
	@cmd.slash_command(name="typingtest")
	@cmd.cooldown(1, 3, cmd.BucketType.user)
	@cmd.check(member_check)
	async def slash_typingtest(self, ctx):
		'''
		A game that tests your typing speed.
		'''
